...
function Home() {
  return (
    <div className='bg-black flex justify-center items-center w-screen top-0 '>
      <div className='text-white w-full  max-w-[1200px] text-center md:text-left px-4 pt-20 md:pt-28'>
        <h1 className="font-sans font-extrabold text-[32px] md:text-[48px] leading-[40px] md:leading-[55px] xl:pr-40">
          We provide creative design <span className='text-lime-400'>solutions</span> <br className='hidden md:block' />
          for everyone.
        </h1>
